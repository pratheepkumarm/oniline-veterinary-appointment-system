        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a href="./?page=applicationstatus" class="nav-link <?= isset($page) && $page =='applicationstatus' ? "active" : "" ?>">Application Status</a>
              </li>
              <li class="nav-item">
                <a href="./?page=homereport" class="nav-link <?= isset($page) && $page =='homereport' ? "active" : "" ?>">Report</a>
              </li>
               <li class="nav-item">
                <a href="login_temp.php" class="nav-link ">Logout</a>
              </li>
